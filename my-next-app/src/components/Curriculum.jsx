...
export default function Curriculum() {
            ...
            about:[
                {
                    ...
                    list:['ChatGPT and Generative AI- Overview','ChatGPT- Applications & Business','']
                }
            ],
        }
    ]
    return (
        <>
            <div className="skillsyard-curriculum-main flex flex-col justify-center items-center">
